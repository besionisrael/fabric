...
The total implementation adds approximately 2\,700 lines of Go and
1\,100 lines of JavaScript to the Fabric tree; no modifications to the Fabric peer
...
Caliper workload drivers                   & —    & 1\,079 \\
\midrule
\textbf{Total}                             & \textbf{2\,683} & \textbf{1\,079} \\
\bottomrule
\end{tabular}
\end{table}
